...
inline std::optional<statistic> basic_test(uint64_t n, stream_uint64 stream) {
	...
	return statistic{statistic_type::z_score, stats.mean, z_test(stats.n, stats.mean, .5, 1. / 12.)};
}
