...
inline stream<uint32_t> xoroshift(uint32_t seed) {
...
inline stream<uint32_t> mt19337(uint32_t seed) {
...
inline stream<uint32_t> minstd_rand(uint32_t seed) {
